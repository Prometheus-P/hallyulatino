---
title: OndaCoreana - Contributing Guide
version: 1.0.0
status: Approved
...
> **OndaCoreana 프로젝트에 기여해 주셔서 감사합니다!**
...
# 2. 포크한 저장소 클론
git clone https://github.com/YOUR_USERNAME/ondacoreana.git
cd ondacoreana

# 3. 업스트림 원격 저장소 추가
git remote add upstream https://github.com/Prometheus-P/ondacoreana.git
